	...
	<div class="full_width">
		<div class="ful_width_nab">
			<ul>
				...
				<li><a href="patientsList.php" class="active">patients list</a></li>
		...
		<div class="table_show_data">
            ...
            <?php while($row = mysqli_fetch_assoc($result)){?>
				  <tr>
				    ...
				    <td>
				    	<a href="updatePatient.php?edit=<?=$row['patient_id'];?>">Update</a> |
				    	<a href="deletePatient.php?delete=<?=$row['patient_id'];?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
